...
| 天数 | 产出 | 入口 |
| --- | --- | --- |
| Day 8-9 | Workflow / Agent / augmented LLM 概念 | [01 学习手册](./01-学习手册.md#day-8-9读懂-react-与-agent-分界) |
| Day 10-12 | `react_agent.py` 主循环 + 三工具 | [01 学习手册](./01-学习手册.md#day-10-12手写-react-循环)、[`../code/react_agent.py`](../code/react_agent.py) |
| Day 13-14 | 失败场景 + Agent 本质三问 | [01 学习手册](./01-学习手册.md#day-13-14主动制造失败) |
...
| 「气温 +10」没调计算器 | 模型心算；见 [01 学习手册](./01-学习手册.md#day-13-14主动制造失败) |
